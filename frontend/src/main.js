...
pluralCaseList.push( {plural: "pets/pets", pascal: "PetPet"} )

pluralCaseList.push( {plural: "feeds/feedings", pascal: "FeedFeeding"} )

pluralCaseList.push( {plural: "statics/statics", pascal: "StaticStatic"} )
