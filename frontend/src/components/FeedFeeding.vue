<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            Feeding # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            Feeding
        </v-card-title >        
        ...
        <v-card-text style="background-color: white;">
            <Number v-if="editMode" label="FeedingId" v-model="value.feedingId" :editMode="editMode" :inputUI="''"/>
            ...
            <String label="FoodType" v-model="value.foodType" :editMode="editMode" :inputUI="''"/>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/feedings'), this.value)
                        } else {
